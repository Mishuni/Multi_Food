		        ...
		        <table cellpadding="0" cellspacing="0" border="0" width="340">
		          <tr>
		            ...
		            <td align="right" width= "100"style="padding=0">
		              <input class="button" type="button" value="수정하기" onclick="location.href='./updateSUG?seq=${detail.seq}&writer=${detail.writer}'"></td>
		            <td align="right" width= "100"style="padding=0">
		              <input class="button" type="button" value="삭제하기" onclick="location.href='./deleteSUG?seq=${detail.seq}&writer=${detail.writer}'"></td>
		          </tr>
		        </table>
		      </td>
		    </tr>
